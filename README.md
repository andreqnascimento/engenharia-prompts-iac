...
* **RepoGit** https://github.com/andreqnascimento/engenharia-prompts-iac

---

## 🧠 Raciocínio e Evolução

O projeto foi desenvolvido em três estágios para demonstrar a evolução da robustez dos prompts:
...
### 3. Versão Schema & Defesa (v3) - A Solução Final 🛡️
